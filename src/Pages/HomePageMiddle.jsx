...
export default function HomePageMiddle({
  ...
  return (
    <div>
      ...
      <div
        className="center sm:w-full md:w-[120%] lg:w-[45rem] overflow-x-auto relative left-1/2 -translate-x-1/2"
        // style={{ width: "100%" }}
      >
        ...
        {filterDiscussion.map((d) => {
          ...
          return (
            <div
              className="mx-4 my-5 rounded-[24px] border border-slate-200/80 bg-gradient-to-b from-white to-slate-50 p-5 shadow-[0_20px_45px_rgba(15,23,42,0.10)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_24px_50px_rgba(15,23,42,0.14)]"
              key={d?._id}
            >
              {/* header */}
